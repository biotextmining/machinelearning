...
public class CreateREModelFile {
	...
	public void setModelFile(IRESchemaCreateModelConfiguration modelConfiguration) throws ANoteException, BioTMLException
	{
		...
		if(bioTMLCorpus!= null){
			...
			if(configuration.getClassType().equals(BioTMLREModelTypes.allclasseswithclues.toString())
					|| configuration.getClassType().equals(BioTMLREModelTypes.allclasseswithcluesonlyannotations.toString())){
